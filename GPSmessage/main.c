...
int main()
{
        ...
        fw=fopen("//Users//a20161104591//Desktop//GPSmessage//output.csv","w+");
   while(fscanf(fp,"%s%s",str1,str2)!=EOF)
    {
        ...
        fprintf(fw,"utc日期 :%c%c日%c%c月%c%c年,",time1[0],time1[1],time1[2],time1[3],time1[4],time[5]);
        for(i=0;i<2;i++)
        {
            state[i]=str2[i+37];
        }
